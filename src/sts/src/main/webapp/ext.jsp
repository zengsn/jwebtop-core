...
<%-- if (not empty _DATAVIEW_) --%>
<script type="text/javascript" src="${_EXT_URL_}/${_EXT_VERSION_}/examples/ux/DataViewTransition.js"></script>
<script type="text/javascript" src="${_EXT_URL_}/${_EXT_VERSION_}/examples/ux/DataView-more.js"></script>
<%-- if (not empty _BUFFERVIEW_) --%>
<script type="text/javascript" src="${_EXT_URL_}/${_EXT_VERSION_}/examples/ux/BufferView.js"></script>
<%-- if (not empty _MESSAGE_) --%>
<link rel="stylesheet" type="text/css" href="${_EXT_URL_}/${_EXT_VERSION_}/examples/shared/examples.css" />
<script type="text/javascript" src="${_EXT_URL_}/${_EXT_VERSION_}/examples/shared/examples.js"></script>
