 ...
 * SAMPLE USAGE:
 *
 * this.startMenu = new JW.StartMenu({
 *		iconCls: 'user',
 *		height: 300,
 *		shadow: true,
...
JW.StartMenu = Ext.extend(Ext.menu.Menu, {
    initComponent: function(config) {
    	JW.StartMenu.superclass.initComponent.call(this, config);
    ...
    onRender : function(ct, position){
        JW.StartMenu.superclass.onRender.call(this, ct, position);
     ...
     * @param {JW.StartMenu} parentMenu (optional) This menu's parent menu, if applicable (defaults to undefined)
     */
